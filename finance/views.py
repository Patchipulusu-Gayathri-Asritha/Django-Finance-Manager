...
def password(request):
    return render(request,'finance/password.html')
...
def search(request):
    if request.session.has_key('is_logged'):
        ...
        return render(request,'finance/tables.html',{'addmoney':addmoney})
    return redirect('home')
...
def addmoney(request):
    return render(request,'finance/addmoney.html')
...
def profile_edit(request, id):
    if request.session.has_key('is_logged'):
        ...
        return render(request, 'finance/profile_edit.html', {
            'user': user,
...
def expense_edit(request,id):
    if request.session.has_key('is_logged'):
        ...
        user_id = request.session["user_id"]
        user1 = User.objects.get(id=user_id)
        return render(request,'finance/expense_edit.html',{'addmoney_info':addmoney_info})
    return redirect("/home")  
...
def stats(request):
    if request.session.has_key('is_logged') :
        ...
        return render(request,'finance/stats.html',{'addmoney':addmoney_info})
...
def weekly(request):
    if request.session.has_key('is_logged') :
        ...
        addmoney_info.x = abs(x)
        addmoney_info.y = abs(y)
    return render(request,'finance/weekly.html',{'addmoney_info':addmoney_info})
...
def info(request):
    return render(request,'finance/info.html')
